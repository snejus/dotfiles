...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "F8", function ()
            ...
            beautiful.volume.update()
        end, {description = "volume up", group = "music / sound"}),

    awful.key({ modkey }, "F7", function ()
            os.execute(string.format("amixer -q set %s 3%%-", beautiful.volume.channel))
            beautiful.volume.update()
        end, {description = "volume down", group = "music / sound"}),
    ...
    awful.key({ altkey }, "0",
        ...
        end, {description = "mpc on/off", group = "music / sound"}),
    awful.key({ modkey }, "F9", function () os.execute("mpc toggle") beautiful.mpd.update() end,
        {description = "mpc toggle : play / pause", group = "music / sound"}),
    awful.key({ modkey }, "F5", function () os.execute("mpc prev") beautiful.mpd.update() end,
        {description = "mpc prev", group = "music / sound"}),
    awful.key({ modkey }, "F6", function () os.execute("mpc next") beautiful.mpd.update() end,
        {description = "mpc next", group = "music / sound"}),
...
awful.rules.rules = {
    ...
    -- Set Brave to always map on the second tag on screen 2.
    { rule = { class = "Brave" },
