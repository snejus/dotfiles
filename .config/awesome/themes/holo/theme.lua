...
--     -- {widget=theme.mpd}
-- )
-- local musicwidget = wibox.container.background(theme.mpd.widget, COLOURS.BEAUTYBLUE)
-- local musicwidget = wibox.container.margin(musicwidget, dpi(10), dpi(10), dpi(5), dpi(5))
